...
it cost me $1 per question, so if you want to afford this expense yourself, you may use your own api keys obtained from [OpenRouter](https://openrouter.ai/docs/api/reference/authentication), and have BYOK perks.

Any missing feature? [➡️](https://github.com/Fusaaaann/llm-council/issues)
